...
<div id="content" class="p-4 p-md-5 pt-5"> {{-- wajib pakai --}}    
        ...
        <form action="{{ url('/Data_Users/update_data/'.$user->id) }}" method="POST">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" class="form-control @error('conpass') is-invalid @enderror" id="conpass" placeholder="Konfirmasi password" name="conpass" value="">
                @error('conpass')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group mb-3">
                ...
                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" placeholder="Masukkan tangga lahir" name="tanggal_lahir" value="{{$user->tanggal_lahir}}">
                @error('tanggal_lahir')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" placeholder="no_hp" name="no_hp" value="{{$user->no_hp}}">
                @error('no_hp')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
