  ...
  <form action="{{url('document/editdocument/'.$documents->no)}}" method="POST" enctype="multipart/form-data">
    ...
    @method('PUT') 
     ...
     <div class="form-group mb-3 ml-4 mr-4">
        ...
        <input type="text" class="form-control @error('nama_dokumen') is-invalid @enderror" id="nama_dokumen" placeholder="Masukkan nama dokumen" name="nama_dokumen" value="{{$documents->nama_dokumen}}">
        @error('nama_dokumen')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
     ...
     <div class="form-group mb-3 ml-4 mr-4">
        ...
        <input type="text" class="form-control @error('perihal') is-invalid @enderror" id="perihal" placeholder="Masukkan perihal dokumen" name="perihal" value="{{$documents->perihal}}">
        @error('perihal')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="form-group mb-3 ml-4 mr-4">
        ...
        <input type="date" class="form-control @error('tanggal_terbit') is-invalid @enderror" id="tanggal_terbit" name="tanggal_terbit" value="{{$documents->tanggal_terbit}}">
    ...
    <div class="form-group mb-3 ml-4 mr-4">
        ...
        <input type="file" class="form-control @error('file_dokumen') is-invalid @enderror" id="file_dokumen" name="file_dokumen" value="{{$documents->file_dokumen}}">
        @error('file_dokumen')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
