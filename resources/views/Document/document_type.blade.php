      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="d-grid d-md-flex justify-content-between">
              Jenis Dokumen
            <a href="{{url('document_type/create')}}" class="btn btn-sm btn-flat btn-success" style="font-size: 0.8em;">Add document type</a>
          </div>
        </div>
        <div class="card-body">
            <table class="table w-100 table-bordered table-hover text-center table-striped" id="document_types">
                ...
                <tbody style="vertical-align: middle">
                    ...
                    <tr>
                        ...
                        <td><a href="{{url('document_type/update/'.$type->id) }}" class="btn btn-sm btn-flat btn-warning"><span class="far fa-edit"></span> Update</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
