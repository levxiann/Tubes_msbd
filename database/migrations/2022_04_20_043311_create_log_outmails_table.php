...
class CreateLogOutmailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_outmails', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('new_tanggal_keluar')->nullable();
            $table->date('old_tanggal_keluar')->nullable();
    ...
    {
        Schema::dropIfExists('log_outmails');
    }
}
